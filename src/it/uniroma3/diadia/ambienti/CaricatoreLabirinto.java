...
public class CaricatoreLabirinto {
	...
	//si è aggiunto un parametro booleano inutile per distinguerlo dal caricatore Da File
	public CaricatoreLabirinto(String stringa, boolean parametroPassato) {
		this.nome2stanza = new HashMap<String,Stanza>();
		this.reader = new LineNumberReader(new StringReader(stringa));
	}
	...
	private void leggiEImpostaUscite() throws FormatoFileNonValidoException {
		...
		try (Scanner scannerDiLinea = new Scanner(specificheUscite)) {			
			...
			while (scannerDiLinea.hasNext()) {
				...
				String stanzaDestinazione = scannerDiLinea.next();		//comprende anche l'eventuale virgola
